                    ...
                    if tasks:
                        for task in tasks:
                            ...
                            with col2:
                                ...
                                st.markdown(f"{priority_colors.get(task['priority'], '⚪')} {task['priority']}", unsafe_allow_html=True)
                            ...
                            with col4:
                                ...
                                st.markdown(f"{status_colors.get(task['status'], '⚪')} {task['status']}", unsafe_allow_html=True)
                    else:
